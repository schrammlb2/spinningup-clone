...
def make_command(env, alg, grad, num_seeds=5, seed_offset=0): 
	...
	run_command = 'source ~/lbs105/venv/pytorch/bin/activate; python -m spinup.run ' + alg + " --env " + env + " --use_grad_penalty " + str(grad) + " --exp_name " + session_name + seed_str
